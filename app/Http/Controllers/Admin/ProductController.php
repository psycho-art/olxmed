...
class ProductController extends Controller
{
    ...
    public function create() {
        ...
        return view('admin.product.add', compact('title', 'category', 'html'));
    }
    ...
    public function edit(Request $request, Product $id) {
        ...
        return view('admin.product.edit', compact('title', 'category', 'html', 'product', 'productImages'));
    }
	...
	public static function laratablesQueryConditions($query)
	{
		...
		return $query->where('id', '>', 0)->where('user_id', auth()->guard('admin')->user()->id);
    }
    ...
    public static function laratablesFeatured($product) 
    {
        return ucfirst($product->featured);
    }
    ...
    {
            return view('admin.product.buttons', compact('product'))->render();
    }

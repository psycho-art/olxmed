...
class Slim
{
    ...
    public static function saveFile($data, $name, $disk = 'public', $uid = true)
    {
    ...
    public static function delete($name, $disk = 'public')
    {
        if (!Storage::disk($disk)->delete($name)) {
            return false;
        }
        return true;
    }
     ...
     * @return bool
     */
    private static function save($data, $name, $disk)
    {
        if (!Storage::disk($disk)->put($name, $data)) {
            return false;
        }
        return true;
    }

                                    ...
                                    <div class="shop-bar d-flex align-items-center">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">{{ ucfirst($keywords) }}.</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="product__single">
                                            ...
                                            <div class="product-action">
                                                <div class="location">
                                                    <span style="color: #72878A; font-size: 0.8em;">{!! (strlen($string) > 31) ? substr($string, 0, 31).'...' : $string !!}</span>
                                                </div>
                                            </div>

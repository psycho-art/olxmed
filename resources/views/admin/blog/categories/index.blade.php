            ...
            <div class="box-header with-border">
                <div class="row">
                    ...
                    <div class="col-md-6" style="display: flex; justify-content: end">
                        <a href="{{ route('admin.blog.category.create') }}" class="btn btn-primary" style="padding: 0.6em 1.2em 0.6em 1.2em;">Add Category</a>
                    </div>
                </div>
            </div>
            <div class="box-body">
...
<script type="text/javascript">
    $(function() {
        var t = $('#pageDataTable').DataTable({
            ...
            processing: true,
            responsive: true,
            ajax: "{{ route('admin.blog.category.datatable') }}",
            "order": [[ 0, "desc" ]],
            "pageLength": 10,
            columns: [
                { name: 'id' },
